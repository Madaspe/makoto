defmodule Makoto.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Makoto.Repo)
    |> unique_constraint(:email)
  end
  ...
  """
  def valid_password?(%Makoto.Accounts.User{hashed_password: hashed_password}, password)
